  ...
  <div class="range-slider">
    ...
    <div class="range-slider__container">
      ...
      <div class="range-slider__values">
        <span class="range-slider__value">{{ formatValue(modelValue[0]) }}</span>
        <span class="range-slider__value">{{ formatValue(modelValue[1]) }}</span>
      </div>
    </div>
  </div>
</template>
...
const isTouchEvent = (e: any): e is TouchEvent => {
  return e && typeof e === 'object' && 'touches' in e && (e as TouchEvent).touches !== undefined
}
...
const fillStyle = computed(() => ({
  ...
  width: `${getPercentage(props.modelValue[1]) - getPercentage(props.modelValue[0])}%`
}))
...
const getValueFromPosition = (clientX: number, element: HTMLElement): number => {
